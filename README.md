About asyncssh-feedstock
========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/asyncssh-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=65&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/asyncssh-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `asyncssh` can be installed with `conda`:
...
```
mamba install asyncssh
```

It is possible to list all of the versions of `asyncssh` available on your platform with `conda`:
...
```
mamba search asyncssh --channel conda-forge
```
...
mamba repoquery search asyncssh --channel conda-forge

# List packages depending on `asyncssh`:
mamba repoquery whoneeds asyncssh --channel conda-forge

# List dependencies of `asyncssh`:
mamba repoquery depends asyncssh --channel conda-forge
```
